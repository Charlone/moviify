...
export default function seriesReducer(state = initialState.series, action) {
    switch (action.type) {
        case types.GET_POPULAR_SERIES_SUCCESS:
            return Object.assign({}, state, {popular: action.popularSeries.results});
        ...
        case types.GET_TOP_SERIES_SUCCESS:
            return Object.assign({}, state, {top: action.topSeries.results});
        ...
        case types.GET_MOVIE_IMAGES_SUCCESS:
            return Object.assign({}, state, {images: action.serieImage.results});
        default:
            return state;
    }
}